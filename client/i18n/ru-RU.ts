export default {
	...
	mainMenu: {
		...
		provider:
			"Я использую сторонние нейросети для получения ответов на твои вопросы.\nТы можешь выбрать, какую из них использовать.\n\nВыбрано: {{provider}}",
		tts: `В дополнение к тексту, я могу ответить голосом.\nТы можешь выбрать: говорить мне или нет.\nТы также можешь настроить озвучку, выбрав "Только озвучка" или "Озвучка с текстом".`,
	},
	...
	basic: {
		...
		processing: "Думаю... 🤔",
		change: "🪄 Изменить",
		onlyTTS: "🌝 Только озвучка",
		textWithTTS: "🌚 Озвучка с текстом",
	},
	...
	errors: {
		...
		tts: "Произошла ошибка при озвучке :(",
	},
};
